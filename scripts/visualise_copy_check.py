...
def visualize(
    ...
    Also tests if deep copying the environment works as expected.
    """
    frames = []
    ...
    for episode in range(num_episodes):
        ...
        # Store the initial state of the original environment
        ...
        assert  initial_state[0].all() ==  final_state.all(), f"States are different: {initial_state} != {final_state}"
        print("Deep copy test passed: Original environment is unaffected.")
